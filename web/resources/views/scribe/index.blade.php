                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-example">
                                <a href="#endpoints-GETapi-example">GET api/example</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-login">POST api/login</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ticket-types">
                                <a href="#endpoints-GETapi-ticket-types">GET api/ticket-types</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ticket-priorities">
                                <a href="#endpoints-GETapi-ticket-priorities">GET api/ticket-priorities</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ticket-statuses">
                                <a href="#endpoints-GETapi-ticket-statuses">GET api/ticket-statuses</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-tickets">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-tickets">
                                <a href="#endpoints-POSTapi-tickets">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-tickets--id-">
                                <a href="#endpoints-GETapi-tickets--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-tickets--id-">
                                <a href="#endpoints-PUTapi-tickets--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-tickets--id-">
                                <a href="#endpoints-DELETEapi-tickets--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-projects">
                                <a href="#endpoints-GETapi-projects">Muestra con todos los proyectos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-projects">
                                <a href="#endpoints-POSTapi-projects">Guarda un nuevo proyecto</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-projects--id-">
                                <a href="#endpoints-GETapi-projects--id-">Muestra el proyecto especificado (ID)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-projects--id-">
                                <a href="#endpoints-PUTapi-projects--id-">Actualiza el proyecto especificado (ID)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-projects--id-">
                                <a href="#endpoints-DELETEapi-projects--id-">Elimina el proyecto especificado (ID)</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-example">GET api/example</h2>
...
<span id="example-requests-GETapi-example">
...
<span id="example-responses-GETapi-example">
            <blockquote>
...
<span id="execution-results-GETapi-example" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-example"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-example"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-example" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-example">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-example" data-method="GET"
      data-path="api/example"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-example', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-example"
                    onclick="tryItOut('GETapi-example');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-example"
                    onclick="cancelTryOut('GETapi-example');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-example"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-example"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-example"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-ticket-types">GET api/ticket-types</h2>
...
<span id="example-requests-GETapi-ticket-types">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/ticket-types" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-ticket-types">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">[
    {
        &quot;id&quot;: 1,
        &quot;name&quot;: &quot;Bug&quot;,
        &quot;created_at&quot;: &quot;2025-05-08T21:50:53.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-05-08T21:50:53.000000Z&quot;
    },
    {
        &quot;id&quot;: 2,
        &quot;name&quot;: &quot;Feature&quot;,
...
<span id="execution-results-GETapi-ticket-types" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-ticket-types"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-ticket-types"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-ticket-types" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-ticket-types">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-ticket-types" data-method="GET"
      data-path="api/ticket-types"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-ticket-types', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-ticket-types"
                    onclick="tryItOut('GETapi-ticket-types');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ticket-types"
                    onclick="cancelTryOut('GETapi-ticket-types');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-ticket-types"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-ticket-types"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-ticket-types"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-ticket-priorities">GET api/ticket-priorities</h2>
...
<span id="example-requests-GETapi-ticket-priorities">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/ticket-priorities" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/ticket-priorities"
);
...
<span id="example-responses-GETapi-ticket-priorities">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-ticket-priorities" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-ticket-priorities"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-ticket-priorities"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-ticket-priorities" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-ticket-priorities">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-ticket-priorities" data-method="GET"
      data-path="api/ticket-priorities"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-ticket-priorities', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-ticket-priorities"
                    onclick="tryItOut('GETapi-ticket-priorities');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ticket-priorities"
                    onclick="cancelTryOut('GETapi-ticket-priorities');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-ticket-priorities"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/ticket-priorities</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-ticket-priorities"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-ticket-priorities"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-ticket-statuses">GET api/ticket-statuses</h2>
...
<span id="example-requests-GETapi-ticket-statuses">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/ticket-statuses" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/ticket-statuses"
);
...
<span id="example-responses-GETapi-ticket-statuses">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-ticket-statuses" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-ticket-statuses"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-ticket-statuses"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-ticket-statuses" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-ticket-statuses">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-ticket-statuses" data-method="GET"
      data-path="api/ticket-statuses"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-ticket-statuses', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-ticket-statuses"
                    onclick="tryItOut('GETapi-ticket-statuses');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ticket-statuses"
                    onclick="cancelTryOut('GETapi-ticket-statuses');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-ticket-statuses"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/ticket-statuses</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-ticket-statuses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-ticket-statuses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-tickets">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-tickets">Store a newly created resource in storage.</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ticket_type_id"                data-endpoint="POSTapi-tickets"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the ticket_types table.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>ticket_priority_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ticket_priority_id"                data-endpoint="POSTapi-tickets"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the ticket_priorities table.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>ticket_status_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ticket_status_id"                data-endpoint="POSTapi-tickets"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the ticket_statuses table.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-tickets"
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                    ...
                    <h2 id="endpoints-GETapi-tickets--id-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/tickets/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the ticket. Example: <code>17</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-tickets--id-">Update the specified resource in storage.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="project_id"                data-endpoint="PUTapi-tickets--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the projects table. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ticket_type_id"                data-endpoint="PUTapi-tickets--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the ticket_types table.</p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ticket_priority_id"                data-endpoint="PUTapi-tickets--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the ticket_priorities table.</p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="ticket_status_id"                data-endpoint="PUTapi-tickets--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the ticket_statuses table.</p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-tickets--id-"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-tickets--id-">Remove the specified resource from storage.</h2>
...
<p>The ID of the ticket. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-projects">Muestra con todos los proyectos</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-projects">Guarda un nuevo proyecto</h2>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                    ...
                    <h2 id="endpoints-GETapi-projects--id-">Muestra el proyecto especificado (ID)</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/projects/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/projects/17"
);
...
<p>The ID of the project. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-projects--id-">Actualiza el proyecto especificado (ID)</h2>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-projects--id-">Elimina el proyecto especificado (ID)</h2>
